...
from backtrace2 import describe_path
...
def shortest_path(grid,start_x,start_y,end_x,end_y):
    ...
    while done == 0:
        ...
        if (cur_point_x + 1) < x_bound:
            if grid[cur_point_x+1][cur_point_y] ==0:
                ...
                #print "right"
                if grid[cur_point_x+1][cur_point_y]==0 or grid[cur_point_x+1][cur_point_y]>counter:
        ...
        if (cur_point_y + 1) < y_bound:
            if grid[cur_point_x][cur_point_y+1] == 0:
                ...
                q.append(counter)
                #print "up"
                if grid[cur_point_x][cur_point_y+1]==0 or grid[cur_point_x][cur_point_y+1]>counter:
    ...
    for i in range (0,x_bound):
        print '%s %s %s %s %s' %(grid[i][0],grid[i][1],grid[i][2], grid[i][3], grid[i][4])
